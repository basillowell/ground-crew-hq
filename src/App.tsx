...
function LandingRoute() {
  // Landing page is visible to everyone — authenticated or not.
  // Authenticated users see "Go to App →" inside LaunchPortalPage itself.
  return (
  ...
  return (
    <AppLayout>
      <Routes>
        ...
        <Route path="invoicing" element={<RouteElementBoundary><Suspense fallback={<PageRouteFallback />}><InvoicingPage /></Suspense></RouteElementBoundary>} />
      </Routes>
    </AppLayout>
  );
}
