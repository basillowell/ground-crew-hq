...
>(({ className, children, ...props }, ref) => {
  ...
  const needsFallbackDescription = !describedBy && !hasDialogDescription(children);
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        {...props}
        aria-describedby={describedBy ?? (needsFallbackDescription ? fallbackDescriptionId : undefined)}
      >
        {children}
...
function hasDialogDescription(children: React.ReactNode): boolean {
  return React.Children.toArray(children).some((child) => {
    ...
    if (type.displayName === DialogPrimitive.Description.displayName) return true;
