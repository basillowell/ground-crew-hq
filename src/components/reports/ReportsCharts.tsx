        ...
        <Card className="rounded-3xl border-0 bg-card/90 backdrop-blur p-5 shadow-sm">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <ComposedChart data={dailyOperations}>
              ...
              <Tooltip />
              <Bar yAxisId="left" dataKey="applications" fill="oklch(var(--warning))" radius={[6, 6, 0, 0]} />
              <Area yAxisId="right" type="monotone" dataKey="et" fill="oklch(var(--chart-green) / 0.18)" stroke="oklch(var(--chart-green))" />
            </ComposedChart>
          </ResponsiveContainer>
        </Card>
        ...
        <Card className="rounded-3xl border-0 bg-card/90 backdrop-blur p-5 shadow-sm">
          ...
          <ResponsiveContainer width="100%" height={280}>
            <ComposedChart data={dailyLabor}>
              ...
              <YAxis yAxisId="right" orientation="right" tick={{ fontSize: 11 }} />
              <Tooltip />
              <Bar yAxisId="left" dataKey="assignments" fill="oklch(var(--chart-green))" radius={[6, 6, 0, 0]} />
              <Line yAxisId="right" type="monotone" dataKey="laborHours" stroke="oklch(var(--chart-blue))" strokeWidth={3} dot={{ r: 3 }} />
            </ComposedChart>
          </ResponsiveContainer>
        </Card>
