...
## turf_mow_patterns  ⏳ PENDING — not yet applied to live DB
| column               | type        | nullable | default           |
|----------------------|-------------|----------|-------------------|
...
> ⏳ Scheduled for equipment/workboard Phase 6 (Turf Management panel).
> Migration not yet run — remove this ⏳ marker and the "PENDING" note once
> applied, per the equipment_module_v2 precedent.
...
## Table count: 45 (46 once turf_mow_patterns is applied — see PENDING note above)
...
## Pending: turf_mow_patterns migration (Workboard Phase 6) not yet applied — do not treat as live schema until this note is removed.
