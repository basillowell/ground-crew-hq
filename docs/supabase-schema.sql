...
alter table public.employees add column if not exists "clubId" text not null default 'club-1';
alter table public.properties add column if not exists "clubId" text not null default 'club-1';
alter table public.property_class_options add column if not exists "clubId" text not null default 'club-1';
alter table public.task_requests add column if not exists "clubId" text not null default 'club-1';
alter table public.tasks add column if not exists "clubId" text not null default 'club-1';
alter table public.equipment_units add column if not exists "clubId" text not null default 'club-1';
alter table public.schedule_entries add column if not exists "clubId" text not null default 'club-1';
alter table public.assignments add column if not exists "clubId" text not null default 'club-1';
alter table public.notes add column if not exists "clubId" text not null default 'club-1';
alter table public.weather_locations add column if not exists "clubId" text not null default 'club-1';
alter table public.weather_stations add column if not exists "clubId" text not null default 'club-1';
alter table public.weather_daily_logs add column if not exists "clubId" text not null default 'club-1';
alter table public.manual_rainfall_entries add column if not exists "clubId" text not null default 'club-1';
alter table public.chemical_products add column if not exists "clubId" text not null default 'club-1';
alter table public.application_areas add column if not exists "clubId" text not null default 'club-1';
alter table public.chemical_application_logs add column if not exists "clubId" text not null default 'club-1';
alter table public.chemical_application_tank_mix_items add column if not exists "clubId" text not null default 'club-1';
alter table public.program_settings add column if not exists "clubId" text not null default 'club-1';
alter table public.department_options add column if not exists "clubId" text not null default 'club-1';
alter table public.group_options add column if not exists "clubId" text not null default 'club-1';
alter table public.role_options add column if not exists "clubId" text not null default 'club-1';
alter table public.language_options add column if not exists "clubId" text not null default 'club-1';
alter table public.work_locations add column if not exists "clubId" text not null default 'club-1';
alter table public.shift_templates add column if not exists "clubId" text not null default 'club-1';
